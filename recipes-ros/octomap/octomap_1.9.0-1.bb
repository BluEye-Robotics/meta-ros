...
SRC_URI = "https://github.com/ros-gbp/octomap-release/archive/release/melodic/${ROS_SPN}/${PV}.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/${ROS_SPN}-release-release-melodic-${ROS_SP}"
