...
DEPENDS = "roscpp roslib actionlib-msgs actionlib audio-common-msgs diagnostic-msgs message-generation roscpp roslib actionlib-msgs audio-common-msgs diagnostic-msgs python-gi gstreamer1.0 gstreamer1.0-plugins-base gstreamer1.0-plugins-ugly gstreamer1.0-plugins-good rospy festival message-runtime"

RDEPENDS_${PN} = "roscpp roslib actionlib-msgs audio-common-msgs diagnostic-msgs python-gi gstreamer1.0 gstreamer1.0-plugins-base gstreamer1.0-plugins-ugly gstreamer1.0-plugins-good rospy festival message-runtime"
