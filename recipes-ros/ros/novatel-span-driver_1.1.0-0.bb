...
DEPENDS = "roslaunch roslint rostest diagnostic-msgs diagnostic-updater geodesy novatel-msgs python-pyserial rospy sensor-msgs std-msgs tf"

RDEPENDS_${PN} = "diagnostic-msgs diagnostic-updater geodesy novatel-msgs python-pyserial rospy sensor-msgs std-msgs tf"
