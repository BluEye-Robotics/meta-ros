...
DEPENDS = "actionlib geometry-msgs moveit-msgs python3-pyassimp rospy shape-msgs tf"

RDEPENDS_${PN} = "actionlib geometry-msgs moveit-msgs python3-pyassimp rospy shape-msgs tf"
