...
DEPENDS = "rostest python-paramiko python-rospkg rosbuild rosgraph roslaunch roslib rosnode rosservice"

RDEPENDS_${PN} = "python-paramiko python-rospkg rosbuild rosgraph roslaunch roslib rosnode rosservice"
