...
DEPENDS = "rqt-py-common python3-pyqt5 roslaunch rospy rqt-console rqt-gui rqt-gui-py rqt-py-common"

RDEPENDS_${PN} = "python3-pyqt5 roslaunch rospy rqt-console rqt-gui rqt-gui-py rqt-py-common"
