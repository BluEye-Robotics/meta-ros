...
DEPENDS = "python3-pyqt5 python3-rospkg qt-gui qt-gui-py-common rqt-gui rqt-gui-py"

RDEPENDS_${PN} = "python3-pyqt5 python3-rospkg qt-gui qt-gui-py-common rqt-gui rqt-gui-py"
