...
SRC_URI = "https://github.com/ENSTABretagneRobotics/sbg_ros_driver-release/archive/release/melodic/sbg_driver/1.1.7-0.tar.gz;downloadfilename=${ROS_BPN}-${PV}.tar.gz"
