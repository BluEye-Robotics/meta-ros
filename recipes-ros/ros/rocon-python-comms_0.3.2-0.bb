...
DEPENDS = "python3-catkin-pkg rostest genpy rospy rosnode rosservice rostopic rosgraph roslib python3-pyyaml rocon-console rocon-service-pair-msgs unique-id uuid-msgs"

RDEPENDS_${PN} = "genpy rospy rosnode rosservice rostopic rosgraph roslib python3-pyyaml rocon-console rocon-service-pair-msgs unique-id uuid-msgs"
