...
DEPENDS = "diagnostic-msgs diagnostic-updater dynamic-reconfigure dynamic-tf-publisher eigen-conversions geometry-msgs image-transport message-generation nodelet roscpp roslaunch rosnode rostest rostime rostopic std-msgs std-srvs tf topic-tools diagnostic-msgs diagnostic-updater dynamic-reconfigure dynamic-tf-publisher eigen-conversions geometry-msgs image-transport message-runtime nodelet  python3-scipy python3-numpy roscpp roslaunch rosnode rostime rostopic sound-play sensor-msgs std-msgs std-srvs tf topic-tools"

RDEPENDS_${PN} = "diagnostic-msgs diagnostic-updater dynamic-reconfigure dynamic-tf-publisher eigen-conversions geometry-msgs image-transport message-runtime nodelet  python3-scipy python3-numpy roscpp roslaunch rosnode rostime rostopic sound-play sensor-msgs std-msgs std-srvs tf topic-tools"
