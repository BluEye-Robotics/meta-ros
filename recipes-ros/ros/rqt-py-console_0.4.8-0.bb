...
DEPENDS = "python-pyqt5 python-rospkg qt-gui qt-gui-py-common rospy rqt-gui rqt-gui-py"

RDEPENDS_${PN} = "python-pyqt5 python-rospkg qt-gui qt-gui-py-common rospy rqt-gui rqt-gui-py"
