...
DEPENDS = "python-catkin-pkg rocon-console rocon-bubble-icons rocon-icons rocon-python-comms rocon-python-utils rocon-std-msgs rocon-uri python-rospkg rospy"

RDEPENDS_${PN} = "rocon-console rocon-bubble-icons rocon-icons rocon-python-comms rocon-python-utils rocon-std-msgs rocon-uri python-rospkg rospy"
