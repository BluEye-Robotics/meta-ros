...
DEPENDS = "std-msgs python3-pillow geometry-msgs message-generation python3-pymongo"

RDEPENDS_${PN} = "rospy roscpp rosgraph rosservice rostopic std-msgs python3-pillow geometry-msgs message-runtime python3-bson"
