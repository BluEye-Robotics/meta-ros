...
DEPENDS = "py-trees py-trees-msgs rqt-bag geometry-msgs python-rospkg python-termcolor qt-dotgraph rospy rqt-graph rqt-gui rqt-gui-py py-trees py-trees-msgs rqt-bag unique-id python-pygraphviz"

RDEPENDS_${PN} = "geometry-msgs python-rospkg python-termcolor qt-dotgraph rospy rqt-graph rqt-gui rqt-gui-py py-trees py-trees-msgs rqt-bag unique-id python-pygraphviz"
