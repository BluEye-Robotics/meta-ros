...
DEPENDS = "python3-pyqt5 rosnode rospy rostopic rqt-gui rqt-gui-py rqt-py-common rqt-topic sensor-msgs"

RDEPENDS_${PN} = "python3-pyqt5 rosnode rospy rostopic rqt-gui rqt-gui-py rqt-py-common rqt-topic sensor-msgs"
