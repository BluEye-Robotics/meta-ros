...
DEPENDS = "rospy std-msgs tf sensor-msgs geometry-msgs diagnostic-msgs rospy std-msgs tf sensor-msgs geometry-msgs diagnostic-msgs python3-pyserial"

RDEPENDS_${PN} = "rospy std-msgs tf sensor-msgs geometry-msgs diagnostic-msgs python3-pyserial"
