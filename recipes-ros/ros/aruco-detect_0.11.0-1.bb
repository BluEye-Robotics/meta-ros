...
DEPENDS = "roscpp tf2-geometry-msgs tf2-ros tf2 visualization-msgs image-transport sensor-msgs cv-bridge fiducial-msgs dynamic-reconfigure python-cairosvg python-joblib"
