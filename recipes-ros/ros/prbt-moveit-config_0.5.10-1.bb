...
SRC_URI = "https://github.com/PilzDE/pilz_robots-release/archive/release/melodic/prbt_moveit_config/0.5.10-1.tar.gz;downloadfilename=${ROS_BPN}-${PV}.tar.gz"
SRC_URI[md5sum] = "340f7c79e37c28c9506fdd57784d6e04"
SRC_URI[sha256sum] = "d2909bf34fd58cfda638e9d60a595e71bd6d7527029deecaf845f5f9e6f7c738"

ROS_SPN = "pilz_robots"
S = "${WORKDIR}/pilz_robots-release-release-melodic-prbt_moveit_config-0.5.10-1"
