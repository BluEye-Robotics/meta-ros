...
SRC_URI = "https://github.com/pr2-gbp/pr2_controllers-release/archive/release/melodic/pr2_calibration_controllers/1.10.17-1.tar.gz;downloadfilename=${ROS_BPN}-${PV}.tar.gz"
