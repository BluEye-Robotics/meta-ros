...
DEPENDS = "angles geographic-msgs geometry-msgs sensor-msgs tf unique-id uuid-msgs python3-catkin-pkg geographic-msgs geometry-msgs python3-pyproj tf sensor-msgs unique-id uuid-msgs"

RDEPENDS_${PN} = "geographic-msgs geometry-msgs python3-pyproj tf sensor-msgs unique-id uuid-msgs"
