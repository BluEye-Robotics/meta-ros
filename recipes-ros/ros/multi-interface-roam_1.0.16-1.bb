...
DEPENDS = "rospy network-monitor-udp std-msgs diagnostic-msgs pr2-msgs asmach dynamic-reconfigure ieee80211-channels rospy network-monitor-udp std-msgs diagnostic-msgs pr2-msgs asmach dynamic-reconfigure ieee80211-channels python3-twisted-core"

RDEPENDS_${PN} = "rospy network-monitor-udp std-msgs diagnostic-msgs pr2-msgs asmach dynamic-reconfigure ieee80211-channels python3-twisted-core"
