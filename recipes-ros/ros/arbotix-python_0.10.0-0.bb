...
DEPENDS = "rospy tf arbotix-msgs sensor-msgs geometry-msgs diagnostic-msgs control-msgs nav-msgs actionlib python-pyserial"

RDEPENDS_${PN} = "rospy tf arbotix-msgs sensor-msgs geometry-msgs diagnostic-msgs control-msgs nav-msgs actionlib python-pyserial"
