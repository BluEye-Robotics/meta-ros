...
DEPENDS = "map-server nav-msgs rosconsole roscpp rospy tf python3-pillow python3-pyyaml yaml-cpp libsdl-image jsk-tools rosmake map-server nav-msgs rosconsole roscpp rospy tf yaml-cpp libsdl-image"
