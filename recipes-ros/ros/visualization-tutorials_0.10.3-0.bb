...
DEPENDS = "interactive-marker-tutorials librviz-tutorial rviz-plugin-tutorials rviz-python3-tutorial visualization-marker-tutorials"

RDEPENDS_${PN} = "interactive-marker-tutorials librviz-tutorial rviz-plugin-tutorials rviz-python3-tutorial visualization-marker-tutorials"
