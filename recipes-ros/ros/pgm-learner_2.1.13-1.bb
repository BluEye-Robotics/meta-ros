...
DEPENDS = "rospy python3-scipy message-generation python3-libpgm-pip rospy python3-scipy message-runtime"

RDEPENDS_${PN} = "python3-libpgm-pip rospy python3-scipy message-runtime"
