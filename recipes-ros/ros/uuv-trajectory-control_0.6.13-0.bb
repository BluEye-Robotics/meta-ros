...
RDEPENDS_${PN} = "rospy roslib python3-numpy python3-matplotlib python3-pyyaml python3-scipy geometry-msgs uuv-control-msgs tf std-msgs nav-msgs visualization-msgs uuv-assistants"
