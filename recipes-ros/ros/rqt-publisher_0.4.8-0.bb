...
DEPENDS = "python3-rospkg python3-pyqt5 qt-gui-py-common roslib rosmsg rqt-gui rqt-gui-py rqt-py-common"

RDEPENDS_${PN} = "python3-rospkg python3-pyqt5 qt-gui-py-common roslib rosmsg rqt-gui rqt-gui-py rqt-py-common"
