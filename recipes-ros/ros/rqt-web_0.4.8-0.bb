...
DEPENDS = "python-pyqt5 python-rospkg qt-gui rospy rqt-gui rqt-gui-py webkit-dependency"

RDEPENDS_${PN} = "python-pyqt5 python-rospkg qt-gui rospy rqt-gui rqt-gui-py webkit-dependency"
