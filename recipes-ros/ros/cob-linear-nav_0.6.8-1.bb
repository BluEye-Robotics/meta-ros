...
SRC_URI = "https://github.com/ipa320/cob_navigation-release/archive/release/melodic/cob_linear_nav/0.6.8-1.tar.gz;downloadfilename=${ROS_BPN}-${PV}.tar.gz"
SRC_URI[md5sum] = "173ef2b6eab3e9ba4933b4a7bc0f0870"
SRC_URI[sha256sum] = "c9fb0f48caf07bb01ae175d00e0d0b66c40e29ba547db13b8a5f40dca2243b3c"

ROS_SPN = "cob_navigation"
S = "${WORKDIR}/cob_navigation-release-release-melodic-cob_linear_nav-0.6.8-1"
