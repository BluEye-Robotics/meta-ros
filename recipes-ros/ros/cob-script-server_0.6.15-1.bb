...
RDEPENDS_${PN} = "message-runtime cob-actions cob-light cob-mimic cob-sound control-msgs geometry-msgs ipython move-base-msgs python-pygraphviz rospy std-msgs std-srvs tf urdfdom-py"
