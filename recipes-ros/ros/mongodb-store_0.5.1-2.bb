...
DEPENDS = "rospy roscpp std-msgs std-srvs message-generation mongodb-store-msgs rostest python-catkin-pkg mongodb libmongoclient-dev openssl topic-tools geometry-msgs rospy roscpp std-msgs std-srvs python-future python-pymongo mongodb mongodb-store-msgs libmongoclient-dev topic-tools geometry-msgs"

RDEPENDS_${PN} = "rospy roscpp std-msgs std-srvs python-future python-pymongo mongodb mongodb-store-msgs libmongoclient-dev topic-tools geometry-msgs"
