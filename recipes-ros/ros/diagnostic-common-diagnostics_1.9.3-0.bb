...
DEPENDS = "rospy diagnostic-updater rostest diagnostic-updater hddtemp rospy tf python-psutil"

RDEPENDS_${PN} = "diagnostic-updater hddtemp rospy tf python-psutil"
