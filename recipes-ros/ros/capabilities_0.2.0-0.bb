...
DEPENDS = "message-generation roslaunch rospy rostest std-msgs std-srvs bondpy message-runtime nodelet python3-pyyaml roslaunch rospy std-msgs std-srvs"

RDEPENDS_${PN} = "bondpy message-runtime nodelet python3-pyyaml roslaunch rospy std-msgs std-srvs"
