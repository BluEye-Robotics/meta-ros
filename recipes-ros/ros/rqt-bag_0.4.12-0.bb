...
DEPENDS = "python-pyqt5 python-rospkg rosbag rosgraph-msgs roslib rosnode rospy rqt-gui rqt-gui-py"

RDEPENDS_${PN} = "python-pyqt5 python-rospkg rosbag rosgraph-msgs roslib rosnode rospy rqt-gui rqt-gui-py"
