...
DEPENDS = "diagnostic-msgs python-pyqt5 qt-gui rospy rqt-console rqt-gui rqt-gui-py rqt-nav-view rqt-robot-monitor"

RDEPENDS_${PN} = "diagnostic-msgs python-pyqt5 qt-gui rospy rqt-console rqt-gui rqt-gui-py rqt-nav-view rqt-robot-monitor"
